// https://raw.githubusercontent.com/kiegroup/kie-docs/6fdd87103f073d458314b76febba3008d9c5733c/doc-content/enterprise-only/openshift/template-deploy-replicas-auth-proc.adoc
