...
import srcImport513 from '../../../content/design-guidelines/extensions/quick-starts/./img/card-elements.png';
import srcImport514 from '../../../content/design-guidelines/extensions/quick-starts/./img/prerequisites.png';
import srcImport515 from '../../../content/design-guidelines/extensions/quick-starts/./img/catalog-elements.png';
import srcImport516 from '../../../content/design-guidelines/extensions/quick-starts/./img/mixed-catalog.png';
import srcImport517 from '../../../content/design-guidelines/extensions/quick-starts/./img/side-panel-elements.png';
import srcImport518 from '../../../content/design-guidelines/extensions/quick-starts/./img/side-panel.png';
import srcImport519 from '../../../content/design-guidelines/extensions/quick-starts/./img/side-panel-resized.png';
import srcImport520 from '../../../content/design-guidelines/extensions/quick-starts/./img/introduction-screen.png';
import srcImport521 from '../../../content/design-guidelines/extensions/quick-starts/./img/task.png';
import srcImport522 from '../../../content/design-guidelines/extensions/quick-starts/./img/check-your-work.png';
import srcImport523 from '../../../content/design-guidelines/extensions/quick-starts/./img/task-yes.png';
import srcImport524 from '../../../content/design-guidelines/extensions/quick-starts/./img/task-no.png';
import srcImport525 from '../../../content/design-guidelines/extensions/quick-starts/./img/qs-context.png';
const pageData = {
  "id": "Quick starts",
  "section": "extensions",
  "source": "design-guidelines",
  "slug": "/extensions/quick-starts/design-guidelines",
  "sourceLink": "https://github.com/patternfly/patternfly-org/blob/main/packages/docs/src/content/design-guidelines/extensions/quick-starts/quick-starts.md"
};
pageData.examples = {
...
const Component = () => (
  <React.Fragment>
    ...
    <img src={srcImport513} height={srcImport513.height * 370 / srcImport513.width} {...{"alt":"Elements of a card","width":"370","className":"ws-img"}}>
    </img>
    <ol {...{"className":"ws-ol"}}>
      <li {...{"className":"ws-li"}}>
        <strong>
    ...
    <img src={srcImport514} height={srcImport514.height * 395 / srcImport514.width} {...{"alt":"Example of prerequisites","width":"395","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport515} height={srcImport515.height * 1680 / srcImport515.width} {...{"alt":"Quick start catalog","width":"1680","className":"ws-img"}}>
    </img>
    <p {...{"className":"ws-p"}}>
    ...
    <img src={srcImport516} height={srcImport516.height * 1062 / srcImport516.width} {...{"alt":"Mixed resource catalog","width":"1062","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport517} height={srcImport517.height * 449 / srcImport517.width} {...{"alt":"Side panel elements","width":"449","className":"ws-img"}}>
    </img>
    <ol {...{"className":"ws-ol"}}>
      <li {...{"className":"ws-li"}}>
        <strong>
    ...
    <img src={srcImport518} height={srcImport518.height * 1680 / srcImport518.width} {...{"alt":"Side panel","width":"1680","className":"ws-img"}}>
    </img>
    <img src={srcImport519} height={srcImport519.height * 1680 / srcImport519.width} {...{"alt":"Resized side panel","width":"1680","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport520} height={srcImport520.height * 449 / srcImport520.width} {...{"alt":"Introduction screen","width":"449","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport521} height={srcImport521.height * 449 / srcImport521.width} {...{"alt":"Example task","width":"449","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport522} height={srcImport522.height * 431 / srcImport522.width} {...{"alt":"Check your work module","width":"431","className":"ws-img"}}>
    </img>
    <p {...{"className":"ws-p"}}>
      {`If a user selects `}
      <strong>
    ...
    <img src={srcImport523} height={srcImport523.height * 449 / srcImport523.width} {...{"alt":"Check your work module with Yes selected","width":"449","className":"ws-img"}}>
    </img>
    <p {...{"className":"ws-p"}}>
      {`If a user selects `}
      <strong>
    ...
    <img src={srcImport524} height={srcImport524.height * 449 / srcImport524.width} {...{"alt":"Check your work module with No selected","width":"449","className":"ws-img"}}>
    </img>
    ...
    <img src={srcImport525} height={srcImport525.height * 1680 / srcImport525.width} {...{"alt":"A quick start in context of a UI","width":"1680","className":"ws-img"}}>
    </img>
  </React.Fragment>
);
Component.displayName = 'ExtensionsQuickStartsDesignGuidelinesDocs';
