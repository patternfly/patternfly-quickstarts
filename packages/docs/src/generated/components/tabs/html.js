...
import '../../../../node_modules/@patternfly/patternfly/docs/components/Tabs/examples/./Tabs.css'
const pageData = {
  "id": "Tabs",
  "section": "components",
  "source": "html",
  "slug": "/components/tabs/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Tabs/examples/Tabs.md",
  "cssPrefix": [
    "pf-c-tabs"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    <AutoLinkHeader {...{"id":"usage-1","size":"h2","className":"ws-title ws-h2"}}>
      {`Usage`}
    </AutoLinkHeader>
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      <thead>
