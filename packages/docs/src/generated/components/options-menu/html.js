...
import '../../../../node_modules/@patternfly/patternfly/docs/components/OptionsMenu/examples/./options-menu.css'
const pageData = {
  "id": "Options menu",
  "section": "components",
  "source": "html",
  "slug": "/components/options-menu/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/OptionsMenu/examples/options-menu.md",
  "cssPrefix": [
    "pf-c-options-menu"
  ],
  "examples": [
