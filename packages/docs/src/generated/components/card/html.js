...
import '../../../../node_modules/@patternfly/patternfly/docs/components/Card/examples/./Card.css'
const pageData = {
  "id": "Card",
  "section": "components",
  "source": "html",
  "slug": "/components/card/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Card/examples/Card.md",
  "cssPrefix": [
    "pf-c-card"
  ],
  "examples": [
...
pageData.examples = {
  ...
  'Hover': props => 
    <Example {...pageData} {...props} {...{"code":"<div class=\"pf-c-card pf-m-hoverable\" id=\"card-hover-example\">\n  <div class=\"pf-c-card__title\">Title</div>\n  <div class=\"pf-c-card__body\">Body</div>\n  <div class=\"pf-c-card__footer\">Footer</div>\n</div>","title":"Hover","lang":"html"}}>
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Hover"])}
