...
import '../../../../node_modules/@patternfly/patternfly/docs/components/MenuToggle/examples/./MenuToggle.css'
const pageData = {
  "id": "Menu toggle",
  "section": "components",
  "source": "html",
  "slug": "/components/menu-toggle/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/MenuToggle/examples/MenuToggle.md",
  "beta": true,
  "cssPrefix": [
    "pf-c-menu-toggle"
  ],
