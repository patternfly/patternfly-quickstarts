...
import srcImportbottomsticky from './html/bottom-sticky.png';
import srcImportbottom from './html/bottom.png';
import srcImportcompact from './html/compact.png';
import srcImporttopdisabled from './html/top-disabled.png';
import srcImporttopexpanded from './html/top-expanded.png';
import srcImporttopsticky from './html/top-sticky.png';
import srcImporttop from './html/top.png';
const pageData = {
  "id": "Pagination",
  "section": "components",
  "source": "html",
  "slug": "/components/pagination/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Pagination/examples/Pagination.md",
  "cssPrefix": [
    "pf-c-pagination"
  ],
  "examples": [
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies for summary display pagination component styles.`}
            </div>
          </td>
        </tr>
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies for full display pagination component styles.`}
            </div>
          </td>
        </tr>
        <tr {...{"role":"row"}}>
