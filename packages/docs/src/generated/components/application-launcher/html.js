...
import '../../../../node_modules/@patternfly/patternfly/docs/components/AppLauncher/examples/./application-launcher.css'
const pageData = {
  "id": "Application launcher",
  "section": "components",
  "source": "html",
  "slug": "/components/application-launcher/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/AppLauncher/examples/application-launcher.md",
  "cssPrefix": [
    "pf-c-app-launcher"
  ],
  "examples": [
