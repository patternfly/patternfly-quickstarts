...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Toolbar/examples/Toolbar.md",
  "cssPrefix": [
    "pf-c-toolbar"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies toolbar horizontal padding.`}
            </div>
          </td>
        </tr>
      </tbody>
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies the width value of a toolbar item.`}
            </div>
          </td>
        </tr>
      </tbody>
    ...
    <AutoLinkHeader {...{"id":"expanded-elements","size":"h3","className":"ws-title ws-h3"}}>
      {`Expanded elements`}
    </AutoLinkHeader>
