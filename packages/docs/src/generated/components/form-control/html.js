...
import '../../../../node_modules/@patternfly/patternfly/docs/components/FormControl/examples/./FormControl.css'
const pageData = {
  "id": "Form control",
  "section": "components",
  "source": "html",
  "slug": "/components/form-control/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/FormControl/examples/FormControl.md",
  "cssPrefix": [
    "pf-c-form-control"
  ],
  "examples": [
