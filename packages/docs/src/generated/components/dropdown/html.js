...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Dropdown/examples/Dropdown.md",
  "cssPrefix": [
    "pf-c-dropdown"
  ],
  "examples": [
