...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/DataList/examples/DataList.md",
  "cssPrefix": [
    "pf-c-data-list"
  ],
  "examples": [
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              ...
              {` to give screen reader users live feedback about what's happening during interaction with the data list, both during drag and drop interactions and keyboard interactions.`}
            </div>
          </td>
        </tr>
        <tr {...{"role":"row"}}>
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies the data list to switch to a grid layout at a specified breakpoint. `}
              <code {...{"className":"ws-code"}}>
                {`.pf-m-grid`}
              </code>
