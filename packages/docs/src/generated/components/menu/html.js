...
import '../../../../node_modules/@patternfly/patternfly/docs/components/Menu/examples/./Menu.css'
const pageData = {
  "id": "Menu",
  "section": "components",
  "source": "html",
  "slug": "/components/menu/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Menu/examples/Menu.md",
  "beta": true,
  "cssPrefix": [
    "pf-c-menu"
  ],
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["With expanded toggle"])}
