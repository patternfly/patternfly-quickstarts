...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/SkipToContent/examples/SkipToContent.md",
  "cssPrefix": [
