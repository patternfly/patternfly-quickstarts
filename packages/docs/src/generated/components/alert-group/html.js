...
import srcImporttoastalertgroup from './html/toast-alert-group.png';
const pageData = {
  "id": "Alert group",
  "section": "components",
  "source": "html",
  "slug": "/components/alert-group/html",
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/AlertGroup/examples/AlertGroup.md",
  "cssPrefix": [
    "pf-c-alert-group"
  ],
  "examples": [
