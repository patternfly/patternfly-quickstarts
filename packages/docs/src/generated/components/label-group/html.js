...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/LabelGroup/examples/LabelGroup.md",
  "beta": true,
  "cssPrefix": [
    "pf-c-label-group"
  ],
...
const Component = () => (
  <React.Fragment>
    ...
    <p {...{"className":"ws-p"}}>
      {`In addition to `}
      <PatternflyThemeLink {...{"to":"../label#editable"}}>
        {`label documentation`}
      </PatternflyThemeLink>
      {`, dynamic label groups should be managed with JavaScript`}
    </p>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        ...
        {` onClick event should (excluding labels within):`}
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Set focus on `}
            <code {...{"className":"ws-code"}}>
