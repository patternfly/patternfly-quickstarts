...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/packages/docs/src/patternfly/components/Select/examples/Select.md",
  "cssPrefix": [
    "pf-c-select"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Checkbox"])}
    ...
    {React.createElement(pageData.examples["Plain expanded"])}
    <p {...{"className":"ws-p"}}>
