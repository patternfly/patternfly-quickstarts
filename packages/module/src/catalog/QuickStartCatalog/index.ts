...
export { default as QuickStartCatalogFilter } from '../QuickStartCatalogFilter/QuickStartCatalogFilter';
...
export * from '../QuickStartCatalogFilter/QuickStartCatalogFilterItems';
export * from '../QuickStartCatalogLayouts';
