...
var LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (uri) {
        ...
        if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
            return monaco_editor_core/* editor.createModel */.j6.createModel(this._libFiles[uri.path.slice(1)], 'javascript', uri);
        }
        return null;
    };
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
                            ...
                            edits.push({
                                resource: monaco_editor_core/* Uri.parse */.Sf.parse(renameLocation.fileName),
                                edit: {
